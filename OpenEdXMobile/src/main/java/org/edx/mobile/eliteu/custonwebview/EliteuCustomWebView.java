 ...
 */
public class EliteuCustomWebView extends FrameLayout implements RefreshListener {
    ...
    private CustomURLInterceptorWebViewClient webViewClient;
    private String url;
    ...
    public EliteuCustomWebView(Context context) {
        super(context);
        init();
    }

    public EliteuCustomWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public EliteuCustomWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CustomURLInterceptorWebViewClient getWebViewClient() {
    ...
    public void loadUrl(boolean forceLoad, @NonNull String url) {
        loadUrlWithJavascript(forceLoad, url, "javascript");
    }

...
import org.edx.mobile.eliteu.bottomnavigation.my.GetProfileFormDescriptionTask;
...
public class EditProfileInfoFragment extends BaseFragment implements BaseFragment.PermissionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getProfileFormDescriptionTask = new GetProfileFormDescriptionTask(activity) {
            ...
            protected void onSuccess(@NonNull FormDescription formDescription) throws Exception {
                EditProfileInfoFragment.this.formDescription = formDescription;
                if (null != viewHolder) {
...
//        viewHolder.username.setContentDescription(ResourceUtil.getFormattedString(getResources(), R.string.profile_username_description, "username", username));
    ...
    public class ViewHolder {
        ...
        public final FrameLayout changePhoto;
            ...
            viewHolder.changePhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (account.requiresParentalConsent()) {
                        ...
                        activity.showAlertDialog(getString(R.string.bind_mobie_dialog_title), getString(R.string.age_limit_tips));
                    } else {
...
//            viewHolder.profileImage.setBorderColorResource(viewHolder.changePhoto.isEnabled() ? R.color.edx_brand_primary_base : R.color.edx_brand_gray_accent);
            ...
            boolean isLimited = account.getAccountPrivacy() != Account.Privacy.ALL_USERS || account.requiresParentalConsent();
                    ...
                    case TEXTAREA: {
                            ...
                            if (null == accountField) {
                                ...
                                switch (field.getDataType()) {
                                    ...
                                    case GENDER:
                                        value = gson.fromJson(accountField, String.class);
                                        try {
                                            text = TextUtils.isEmpty(value) ? null : getGenderNameFromCode(value);
                                        } catch (InvalidLocaleException e) {
                                            continue;
                                        }
                                        break;
                        ...
                        if (TextUtils.isEmpty(text)) {
                            ...
                            if (field.getName().equals("bio")) {
                                displayValue = getResources().getString(R.string.signature_view_detail);
                            }
                        }
    ...
    private String getGenderNameFromCode(String value) throws InvalidLocaleException {
        String text = "";
        if (value.equalsIgnoreCase("m")) {
            text = getResources().getString(R.string.man);
        } else if (value.equalsIgnoreCase("f")) {
            text = getResources().getString(R.string.women);
        } else if (value.equalsIgnoreCase("o")) {
            text = getResources().getString(R.string.gender_other);
        }
        return text;
    }
        ...
        userService.updateAccount(username, Collections.singletonMap(field.getName(), valueObject))
                .enqueue(new AccountDataUpdatedCallback(getActivity(), username,
                    ...
                    protected void onResponse(@NonNull final Account account) {
                        ...
                        EditProfileInfoFragment.this.account = account;
                        setData(account, formDescription);
                    }
                });
    }
    ...
    private static RelativeLayout createField(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent, @NonNull final FormField field, @NonNull final String value, boolean readOnly, @NonNull View.OnClickListener onClickListener) {
        final RelativeLayout relativeLayout = (RelativeLayout) inflater.inflate(R.layout.eliteu_edit_user_profile_field, parent, false);
        TextView key_tv = relativeLayout.findViewById(R.id.key);
        TextView value_tv = relativeLayout.findViewById(R.id.value);
        key_tv.setText(field.getLabel());

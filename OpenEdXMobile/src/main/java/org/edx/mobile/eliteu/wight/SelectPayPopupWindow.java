...
public class SelectPayPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    private RelativeLayout paytype_of_wechat, paytype_of_alipay;
    ...
    public SelectPayPopupWindow(Context context, String price) {
        ...
        progress = mMenuView.findViewById(R.id.progress);
        pay_submit_btn = mMenuView.findViewById(R.id.pay_submit_btn);
        ...
        mPriceTips = mMenuView.findViewById(R.id.price_tips);
        pay = mMenuView.findViewById(R.id.pay);
        priceTv.setText(PriceUtil.OtherPriceFormat("", price));
    ...
    public void setPwCanDissmiss(boolean pwCanDissmiss) {
        this.pwCanDissmiss = pwCanDissmiss;
    }

    public void showProgress() {
        progress.setVisibility(View.VISIBLE);
        pay_submit_btn.setText(mContext.getString(R.string.pay_submit_lable) + "...");
        pay.setEnabled(false);
        paytype_of_wechat.setEnabled(false);
        paytype_of_alipay.setEnabled(false);
        paytype_of_wechat_rb.setEnabled(false);
        paytype_of_alipay_rb.setEnabled(false);
    ...
    public void hideProgress() {
        ...
        pay_submit_btn.setText(mContext.getString(R.string.pay_submit_lable));
        pay.setEnabled(true);
        paytype_of_wechat.setEnabled(true);
        paytype_of_alipay.setEnabled(true);
        paytype_of_wechat_rb.setEnabled(true);
        paytype_of_alipay_rb.setEnabled(true);

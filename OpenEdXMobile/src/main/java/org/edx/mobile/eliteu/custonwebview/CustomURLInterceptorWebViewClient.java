 ...
 */
public class CustomURLInterceptorWebViewClient extends WebViewClient {

    private final Logger logger = new Logger(CustomURLInterceptorWebViewClient.class);
    ...
    public CustomURLInterceptorWebViewClient(FragmentActivity activity, WebView webView) {
